...
\multirow{2}{*}{\textbf{\#}} & \multirow{2}{*}{\textbf{Models}} & \textbf{$\uparrow$ Accuracy} & $\uparrow$ \textbf{Correct} & $\downarrow$ \textbf{Same-group} & $\downarrow$ \textbf{Cross-group} \\%& $\uparrow$ \textbf{Same}\\ 
&  &  \textbf{(\%)} & \textbf{(S)}& \textbf{Error (S)} & \textbf{Error (S)}  \\\hline % &\textbf{Topic}\\\hline
